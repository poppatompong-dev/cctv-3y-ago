...
const PROJECT_DATA = [
    {
        ...
        logs: [
            { time: "12/04/2567 16:00", text: "ส่งงาน ทดสอบสัญญาณและภาพเชื่อมต่อไปยังศูนย์ควบคุมเรียบร้อย", tech: "ช่างเทคนิค: พัชรพล แสงทอง" },
            { time: "10/04/2567 11:30", text: "ทำการติดตั้งกล้อง ยึดฐานเสาไฟใหม่ และจัดระเบียบโครงสร้าง", tech: "ช่างเทคนิค: สมชาย ใจดี" },
            { time: "08/04/2567 09:00", text: "ขุดเปิดหน้าดิน เดินท่อร้อยสายใยแก้วนำแสงใต้ดินแนวเส้นทางใหม่", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
        imgBefore: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=300&q=80",
        imgAfter: "https://images.unsplash.com/photo-1511556532299-8f662fc26c06?auto=format&fit=crop&w=300&q=80"
    },
    {
        id: 2,
        year: 2567,
        ...
        logs: [
            { time: "25/05/2567 14:00", text: "ทำความสะอาดหน้ากระจกเฮ้าส์ซิ่งเลนส์กล้อง ทดสอบซูมและโฟกัสครบ 32 ตัว", tech: "ช่างเทคนิค: สมชาย ใจดี" },
            { time: "22/05/2567 10:15", text: "เปลี่ยนพาวเวอร์ซัพพลายขนาดเล็กภายในตัวกล้อง และมีเดียคอนเวอร์เตอร์ไฟเบอร์จำนวน 6 ตัว", tech: "ช่างเทคนิค: วิชัย เลิศล้ำ" },
            { time: "20/05/2567 09:00", text: "ตรวจหาตำแหน่งสายเชื่อมชำรุดบนตัวเสา และเปลี่ยนสาย UTP แพทช์ภายนอกอาคาร", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
        imgBefore: "https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=300&q=80",
        imgAfter: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=300&q=80"
    },
    {
        id: 3,
        year: 2567,
        ...
        note: "ซ่อมระบบกล้องตามรายงาน",
        logs: [
            { time: "11/06/2567 16:30", text: "ตรวจรับงานเสร็จสิ้น วิ่งกระแสไฟเสถียรดี ติดตั้งระบบเซิร์จกันไฟกระชาก (Surge Protector)", tech: "ช่างเทคนิค: วิชัย เลิศล้ำ" },
            { time: "09/06/2567 13:00", text: "ดำเนินการสลับเอาบอร์ดอะไหล่และชุดเลนส์ตัวใหม่เข้าไปทดแทนตัวที่เสียหายจากฟ้าผ่า", tech: "ช่างเทคนิค: พัชรพล แสงทอง" },
            { time: "08/06/2567 08:30", text: "ตรวจสอบแรงดันไฟต้นทาง พบฟิวส์ไฟในตู้คอนโทรลขาดเนื่องจากกระแสไฟฟ้าตก/กระชาก", tech: "ช่างเทคนิค: สมชาย ใจดี" }
        ],
        imgBefore: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=300&q=80",
        imgAfter: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=300&q=80"
    },
    {
        id: 4,
        year: 2567,
        ...
        note: "ซ่อมระบบกล้องตามรายงาน",
        logs: [
            { time: "18/09/2567 17:00", text: "เซ็ตพิกัดโปรแกรมการหมุนวนกวาดภาพ (Patrol Preset) ครบทุกกล้องเพื่อความคลอบคลุมพื้นที่", tech: "ช่างเทคนิค: สมชาย ใจดี" },
            { time: "15/09/2567 11:00", text: "ซ่อมแกนขับเคลื่อนมอเตอร์กล้องโดมหมุนส่าย (PTZ) 8 ตัวที่มีอาการฝืดขัดส่ายแล้วสะดุด", tech: "ช่างเทคนิค: พัชรพล แสงทอง" },
            { time: "12/09/2567 09:00", text: "ตรวจสภาพสารกันชื้นภายในกล้อง และเปลี่ยนแผ่นยางโอริงซีลกรอบกระจกเพื่อกันน้ำเข้า", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
        imgBefore: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=300&q=80",
    ...
    },
    {
        ...
        desc: "ตรวจสอบเชิงลึกและบำรุงรักษาซ่อมกล้องจำนวน 38 ตัวในบริเวณอาคารขนส่งผู้โดยสาร จุดบริการชานชาลา และประตูด้านหน้า-หลังของสถานีขนส่งนครสวรรค์ เพื่อความปลอดภัยขั้นสูงสุดในการเดินทางของชาวเมืองและนักท่องเที่ยว",
        note: "ซ่อมระบบกล้องตามรายงาน",
        logs: [
            { time: "28/11/2567 15:45", text: "อัปเกรดเฟิร์มแวร์กล้องเพื่อความเสถียรและทดสอบการส่องสว่างแบบไฟอินฟราเรด (IR) กลางคืน", tech: "ช่างเทคนิค: วิชัย เลิศล้ำ" },
            { time: "25/11/2567 10:00", text: "เปลี่ยนหลอดอินฟราเรดที่ชำรุดเสื่อมแสงส่งผลให้มองไม่เห็นในที่มืดสนิท จำนวน 12 กล้อง", tech: "ช่างเทคนิค: สมชาย ใจดี" },
            { time: "22/11/2567 08:30", text: "ซ่อมบำรุงขั้วต่อ RJ45 และกล่องกันน้ำเข้าภายนอกตู้พักกระจายสัญญาณของสถานีขนส่ง", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
        imgBefore: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=300&q=80",
        imgAfter: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=300&q=80"
    },
    {
        id: 6,
        year: 2568,
        ...
        logs: [
            { time: "18/02/2568 15:00", text: "สไปรซ์สายไฟเบอร์ออปติกที่ขาดเรียบร้อย สัญญาณแสงผ่านเกณฑ์มาตรฐาน", tech: "ช่างเทคนิค: วิชัย เลิศล้ำ" },
            { time: "15/02/2568 10:00", text: "ตรวจหาตำแหน่งสายเคเบิลขาดเนื่องจากโดนกิ่งไม้ตกกระแทกทับ", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
    ...
    },
    {
        ...
        logs: [
            { time: "30/04/2568 16:30", text: "ติดแถบสีสะท้อนแสงเขียว-ขาว และพิมพ์ป้ายแท็กรหัสเสร็จตามเสาสายหลักครบถ้วน", tech: "ช่างเทคนิค: สมชาย ใจดี" },
            { time: "20/04/2568 10:00", text: "พันแถบพลาสติกสีระบุท่อส่งผ่านสายไฟเบอร์ตามจุดคอเสาไฟฟ้าสายหลัก", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
    ...
    },
    {
        ...
        note: "ในรายงานใช้คำว่า สายสัญญาณและระบบไฟฟ้า",
        logs: [
            { time: "18/09/2568 16:00", text: "เปลี่ยนตู้พักปลายทาง (Cabinet Box) และสวิตช์แลกเปลี่ยนสัญญาณจำนวน 4 โหนด", tech: "ช่างเทคนิค: พัชรพล แสงทอง" },
            { time: "12/09/2568 11:00", text: "เปลี่ยนปลั๊กเบรกเกอร์ไฟ และสายกราวด์เดินดินลดผลกระทบฟ้าผ่าในจุดพักสายสนามกีฬากลาง", tech: "ช่างเทคนิค: สมชาย ใจดี" }
        ],
        imgBefore: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=300&q=80",
        imgAfter: "https://images.unsplash.com/photo-1542744094-3a31f103e35f?auto=format&fit=crop&w=300&q=80"
    },
    {
        id: 9,
        year: 2569,
        ...
        logs: [
            { time: "10/05/2569 14:00", text: "ความคืบหน้ารวม 85% ดำเนินการสไปรซ์จัดแนวสายหลักเข้าอาคารราชการเรียบร้อย", tech: "ช่างเทคนิค: วิชัย เลิศล้ำ" },
            { time: "02/05/2569 09:30", text: "ติดตั้งตัวสำรองไฟอัจฉริยะ (Smart UPS Inline) เพื่อป้องกันระบบดับชั่วคราวขณะไฟตก", tech: "ช่างเทคนิค: มานะ มั่นคง" }
        ],
